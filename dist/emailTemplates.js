...
exports.generateAdminEmailTemplate = generateAdminEmailTemplate;
exports.generateCustomerEmailTemplateWithAttachments = generateCustomerEmailTemplateWithAttachments;
function generateCustomerEmailTemplate(contract, user) {
    var _a, _b;
    return `
    <div style="font-family: Arial, sans-serif; padding: 20px; color: #333;">
      ...
      <ul style="line-height: 1.6;">
        <li><strong>Car:</strong> ${contract.carMake} ${contract.carModel} (${contract.carColor})</li>
        <li><strong>License Plate:</strong> ${contract.carLicenseNo}</li>
        <li><strong>Rental Dates:</strong> ${contract.dateOut} ${contract.timeOut} → ${contract.dateDue} ${contract.timeIn}</li>
        <li><strong>Rental Duration:</strong> ${contract.noOfDays} day(s)</li>
        <li><strong>Daily Rate:</strong> $${contract.carDailyRate.toFixed(2)}</li>
        <li><strong>Total:</strong> $${(_a = contract.amountPaid) === null || _a === void 0 ? void 0 : _a.toFixed(2)}</li>
      </ul>

      ${((_b = contract.additionalCars) === null || _b === void 0 ? void 0 : _b.length)
        ? `
        <h4 style="margin-top: 20px;">Additional Cars</h4>
        <ul style="line-height: 1.6;">
          ${contract.additionalCars
            .map((car) => `<li>${car.carMake} ${car.carModel} (${car.carLicenseNo}) @ $${car.carDailyRate.toFixed(2)}/day</li>`)
            .join("")}
        </ul>
      `
        : ""}
...
function generateAdminEmailTemplate(contract, user, platformUrl) {
    var _a, _b;
    return `
    <div style="font-family: Arial, sans-serif; padding: 20px; color: #222;">
      ...
      <ul style="line-height: 1.6;">
        <li><strong>Vehicle:</strong> ${contract.carMake} ${contract.carModel} (${contract.carColor})</li>
        <li><strong>License Plate:</strong> ${contract.carLicenseNo}</li>
        <li><strong>Daily Rate:</strong> $${contract.carDailyRate.toFixed(2)}</li>
        <li><strong>Rental Duration:</strong> ${contract.noOfDays} day(s)</li>
        <li><strong>Subtotal:</strong> $${(contract.carDailyRate * (contract.noOfDays || 1)).toFixed(2)}</li>
      </ul>

      ${((_a = contract.additionalCars) === null || _a === void 0 ? void 0 : _a.length)
        ? `
          ...
          ${contract.additionalCars
            .map((car) => `
              <li>
                ...
                $${car.carDailyRate.toFixed(2)}/day × ${contract.noOfDays} days = 
      ...
      <h3>Total Amount: <span style="color: green;">$${(_b = contract.amount) === null || _b === void 0 ? void 0 : _b.toFixed(2)}</span></h3>
...
function generateCustomerEmailTemplateWithAttachments(contract, user) {
    var _a, _b;
    const formatTime = (t) => {
        if (!t)
            return "";
    ...
    const shortId = (_b = (_a = contract.id) === null || _a === void 0 ? void 0 : _a.slice(0, 6).toUpperCase()) !== null && _b !== void 0 ? _b : "N/A";
    return `
  <div style="font-family: Arial, sans-serif; max-width: 720px; margin: 0 auto; padding: 30px; background: #f9f9f9; color: #333;">
    ...
    <table cellspacing="0" cellpadding="5" style="width: 100%; border-collapse: collapse;">
      ...
      <tr><td><strong>Permit #:</strong></td><td>${contract.permitNumber}</td></tr>
      <tr><td><strong>Issue Date:</strong></td><td>${contract.issueDate}</td></tr>
      <tr><td><strong>Expiry Date:</strong></td><td>${contract.expiryDate}</td></tr>
      <tr><td><strong>Birth Date:</strong></td><td>${contract.birthDate}</td></tr>
    ...
    <table cellspacing="0" cellpadding="5" style="width: 100%; border-collapse: collapse;">
      <tr><td><strong>Car:</strong></td><td>${contract.carMake} ${contract.carModel} (${contract.carColor})</td></tr>
      <tr><td><strong>License Plate:</strong></td><td>${contract.carLicenseNo}</td></tr>
      <tr><td><strong>Daily Rate:</strong></td><td>$${contract.carDailyRate.toFixed(2)}</td></tr>
      <tr><td><strong>Rental Dates:</strong></td><td>${contract.dateOut} ${formatTime(contract.timeOut)} → ${contract.dateDue} ${formatTime(contract.timeIn)}</td></tr>
    ...
    ${contract.amount !== undefined
        ? `<p style="margin-top: 20px; font-size: 16px;"><strong>Total Estimated Amount:</strong> <span style="color: green;">$${contract.amount.toFixed(2)}</span></p>`
        : ""}
