...
export function generateAdminEmailTemplate(
  ...
  return `
    ...
    contract.carModel
      ...
      <p style="margin-top: 30px;">
        <a href="${platformUrl}admin/clients/print/${
    contract.id
  }" style="display:inline-block; background-color:#0B5394; color:#fff; padding:10px 20px; border-radius:5px; text-decoration:none;">
